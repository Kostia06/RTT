        ...
        <div className="relative z-10 max-w-xl mx-auto px-4 sm:px-6 lg:px-12 w-full">
          ...
          <div className="hero-subtitle space-y-4">
            ...
            <div className="pt-6 border-t border-white/10">
              <p className="text-sm text-white/40 uppercase tracking-[0.2em]">Trusted by ramen enthusiasts</p>
            </div>
          </div>
        ...
        <div ref={formRef} className="max-w-md w-full">
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-xs tracking-[0.3em] text-gray-400 uppercase">Sign In</span>
              <div className="h-px bg-black/10 flex-1" />
            </div>
            <h2 className="text-2xl font-black text-black mb-2">Access Your Account</h2>
