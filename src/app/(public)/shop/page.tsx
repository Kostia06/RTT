  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div ref={heroRef} className="relative bg-black text-white overflow-hidden">
        ...
        {/* Floating Kanji */}
        <div className="hero-kanji absolute top-20 right-[10%] text-[30vw] font-black text-white/[0.02] leading-none pointer-events-none select-none">
          店
        </div>

        <div className="relative py-40 pt-48">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="flex items-center gap-3 mb-12">
              ...
              <span className="text-xs tracking-[0.2em] uppercase text-white/70">Shop</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              {categories.map((cat) => (
                <button
                  ...
                  className={`relative px-6 py-3 text-sm font-medium tracking-[0.1em] uppercase transition-all duration-300 group ${
                ...
                >
                  <span className="relative z-10 flex items-center gap-2">
                    <span className={`text-lg transition-opacity ${selectedCategory === cat.id ? 'opacity-100' : 'opacity-40 group-hover:opacity-70'}`}>
                      {cat.kanji}
                    </span>
                    {cat.label}
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-32">
              ...
              <p className="mt-6 text-sm text-gray-400 tracking-[0.1em] uppercase">Loading products...</p>
            </div>
          ) : products.length === 0 ? (
            <div className="text-center py-32">
              <div className="w-24 h-24 mx-auto mb-8 border-2 border-gray-200 flex items-center justify-center">
                <span className="text-4xl text-gray-300">空</span>
              </div>
              ...
              <button
                ...
                className="px-8 py-4 bg-black text-white text-sm font-bold tracking-[0.1em] uppercase hover:bg-gray-800 transition-colors"
              >
                View All Products
              </button>
            </div>
          ) : (
            <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                  ...
                  <Link href={`/shop/${product.slug}`} className="block">
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden">
                      ...
                      <div className={`absolute inset-0 bg-black/40 flex items-center justify-center transition-opacity duration-300 ${
                        ...
                        <span className="px-8 py-3 border border-white text-white text-sm tracking-[0.2em] uppercase">
                          View Details
                        </span>
                      </div>
                      ...
                      {/* Category badge */}
                      <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-black px-3 py-1 text-[10px] tracking-[0.2em] uppercase">
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-sm text-gray-400">.{(product.price % 1).toFixed(2).slice(2)}</span>
                        </div>
                      </div>
                    </div>
                  </Link>
          ...
          {!loading && products.length > 0 && (
            <div className="mt-16 pt-8 border-t border-gray-200">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <Link
                  href="/classes"
                  className="inline-flex items-center gap-3 text-sm tracking-[0.1em] uppercase font-medium text-gray-600 hover:text-black transition-colors group"
                >
